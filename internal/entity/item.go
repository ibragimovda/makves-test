...
type Item struct {
	...
	MemberOfIndirectGroupsIds sql.NullString `json:"member_of_indirect_groups_ids" db:"member_of_indirect_groups_ids"`
	MemberOfGroupsIds         sql.NullString `json:"member_of_groups_ids" db:"member_of_groups_ids"`
	IsAdmin                   sql.NullInt16  `json:"is_admin" db:"is_admin"`
